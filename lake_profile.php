...
$lakedetails = $ControllerLake->getLakeDetailsWithID($_GET['id'],$CultureID);
...
$lakes = $ControllerLake->getLakeWithID($_GET['id']);
$relation_entities = $ControllerArchivedObject->getRelationEntitiesOfArchivedObjectID($_GET['id']);
$map_details = $ControllerLake->getLakeWithID($_GET['id']);
            ...
            <div class="container">
              <nav class="breadcrumb">
               <a class="breadcrumb-item" href="#">Αρχική &nbsp;/</a>
                ...
                <a class="breadcrumb-item" href="#"><?php echo $lang['lakes']; ?> &nbsp;/</a>
                <span class="breadcrumb-item active"><?php echo $lakedetails[0]->FriendlyName ?> &nbsp;</span>
              </nav>
                    ...
                    <div class="tab-pane active" id="tab-all" role="tabpanel">
                      <div class="listing-boxes">
                           ...
                           <table class="table table-bordered opening-hours">
                              <tbody>
                                <?php foreach ($lakedetails as $lakedetail) { ?>
                                      <?php if(!IsNullOrEmpty($lakedetails[0]->FriendlyName)){ ?>
                                      <tr>
                                        <th class="min-width center"><?php echo $lang['koini_onomasia']; ?></th>
                                        <td><?php echo $lakedetail->FriendlyName?></td>
                                      </tr>
                                      <?php  } ?>

                                      <?php if(!IsNullOrEmpty($lakedetails[0]->OfficialName)){ ?>
                                      <tr>
                                        <th class="min-width center"><?php echo $lang['OfficialName']; ?></th>
                                        <td><?php echo $lakedetail->OfficialName?></td>
                                      </tr>
                                      <?php  } ?>
                                   <?php  } ?>
                              </tbody>
...
<!-- ************************************************************************* START OF MAIN PAGE *************************************************************************** -->
 ...
 <!-- ************************************************************************* START OF RIGHT SIDEBAR *************************************************************************** -->
    ...
    <script type="text/javascript">
      ...
      var url = "ajax/filter_lake_relations_with_all.php?";
