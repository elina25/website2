...
$mountaindetails = $ControllerMountain->getMountainsDetailsWithID($_GET['id'],$CultureID);
...
$geos = $ControllerMainUnities->getAllGeoUnities();
$map_details = $ControllerMountain->getMountainsWithID($_GET['id']);
          ...
          <div class="main-inner">
            ...
            <div class="container">
              ...
              <nav class="breadcrumb">
                ...
                <a class="breadcrumb-item" href="#"><?php echo $lang['mountain'];?> &nbsp;/</a>

                <span class="breadcrumb-item active"><?php echo $mountaindetails[0]->friendlyName ?> &nbsp;/</span>
                    ...
                    <div class="tab-pane active" id="tab-all" role="tabpanel">
                      ...
                      <div class="listing-boxes">
                            ...
                            <table class="table table-bordered opening-hours">
                              <tbody>
                                <?php foreach ($mountaindetails as $mountaindetail) { ?>

                                  
                                      <?php if(!IsNullOrEmpty($mountaindetails[0]->friendlyName)){ ?>
                                      <tr>
                                        <th class="min-width center"><?php echo $lang['koini_onomasia']; ?></th>
                                        <td><?php echo $mountaindetail->friendlyName?></td>
                                      </tr>
                                      <?php  } ?>

                                      <?php if(!IsNullOrEmpty($mountaindetails[0]->officialName)){ ?>
                                      <tr>
                                        <th class="min-width center"><?php echo $lang['OfficialName']; ?></th>
                                        <td><?php echo $mountaindetail->officialName?></td>
                                      </tr>
                                      <?php  } ?>
                                   <?php  } ?>
                                </tbody>
...
<div id="modal-submit" class="modal fade">    
    ...
    <script type="text/javascript">
      ...
      var url = "ajax/filter_mountain_relations_with_all.php?";
