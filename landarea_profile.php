...
$landetails = $ControllerLandarea->getLandAreasDetailWithID($_GET['id'],$CultureID);
...
$map_details = $ControllerLandarea->getMapDetailsWithID($_GET['id']);
          ...
          <div class="main-inner">
            ...
            <div class="container">
              ...
              <nav class="breadcrumb">
                ...
                <a class="breadcrumb-item" href="#"><?php echo $lang['landareas']; ?> &nbsp;/</a>
                    ...
                    <div class="tab-pane active" id="tab-all" role="tabpanel">
                      ...
                      <div class="listing-boxes">
                            ...
                            <table class="table table-bordered opening-hours">
                              <tbody>
                                <?php foreach ($landetails as $landetail) { ?>

                                  
                                      <?php if(!IsNullOrEmpty($landetails[0]->FriendlyName)){ ?>
                                      <tr>
                                        <th class="min-width center"><?php echo $lang['koini_onomasia']; ?></th>
                                        <td><?php echo $landetail->FriendlyName?></td>
                                      </tr>
                                      <?php  } ?>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $landetail->OfficialName?></td>
                                      </tr>
                                      <?php  } ?>
                                   <?php  } ?>
                                </tbody>
...
<!-- ************************************************************************* START OF MAIN PAGE *************************************************************************** -->
 ...
 <!-- ************************************************************************* START OF RIGHT SIDEBAR *************************************************************************** -->
    ...
    <script type="text/javascript">
      ...
      var url = "ajax/filter_landarea_relations_with_all.php?";
