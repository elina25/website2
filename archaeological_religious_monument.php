...
//session_start();
$ControllerArchaeologicalReligiousMonument = new ControllerArchaeologicalReligiousMonument();
...
//$details = $ControllerArchaeologicalReligiousMonument->getSomeDetailsForArchRel($_GET['id']);
//$characters = $ControllerArchaeologicalReligiousMonument->getCharacterDetailsForArchRel($_GET['id']);
$informations = $ControllerArchaeologicalReligiousMonument->getReligiousMonumentDetails($_GET['id'],$culture_id);
//$kinds = $ControllerArchaeologicalReligiousMonument->getKindforArchRel($_GET['id']);
...
<html lang="en">
  <head>
    ...
    <title><?php echo $lang['ReligiousMonument']; ?></title>
  </head>
  <body class="">
              ...
              <div class="listing-hero-inner">
                <div class="container">
                 <?php foreach ($informations as $information) { ?>
                  <h1><?php echo $information->friendlyname;?></h1>
                  <?php } ?>
              </div>
                <!-- /.container -->
              </div>
            ...
            <div class="container">
              <nav class="breadcrumb">
               <a class="breadcrumb-item" href="#">Αρχική</a>
                ...
                <a class="breadcrumb-item" href="#"><?php echo $lang['ReligiousMonument']; ?></a>
                <span class="breadcrumb-item active"><?php echo $informations[0]->friendlyname ?></span>
              </nav>
                              ...
                              <h2><?php echo $lang['details']; ?></h2>
                                <div class="box">
                                  <div class="box-inner">
                                    ...
                                    <?php foreach ($informations as $information) { ?>
                                        <?php
                                              MakeItemList($information, 'officialName', $lang, 'OfficialName');
                                              MakeItemList($information, 'friendlyName', $lang, 'FriendlyName');
                                              MakeItemList($information, 'phoneticTranscription', $lang);
                                              MakeItemList($information, 'epochs', $lang);
                                              MakeItemList($information, 'localName', $lang);
                                              MakeItemList($information, 'address', $lang);
                                              MakeItemList($information, 'Origin', $lang);
                                              MakeItemList($information, 'contact', $lang);
                                              MakeItemList($information, 'Info', $lang);
                                              MakeItemList($information, 'description_form', $lang);
                                              MakeItemList($information, 'embedded_artwork', $lang);
                                              MakeItemList($information, 'founder', $lang);
                                              MakeItemList($information, 'artists', $lang);
                                              MakeItemList($information, 'constructionsAndRennovations', $lang);
                                              MakeItemList($information, 'historicalData', $lang);
                                              MakeItemList($information, 'comments', $lang);
                                              MakeItemList($information, 'people', $lang);
                                              MakeItemList($information, 'areincluded', $lang);
                                              MakeItemList($information, 'benefactors', $lang);
...
<!-- ************************************************************************* START OF MAIN PAGE *************************************************************************** -->
 ...
 <!-- ************************************************************************* START OF RIGHT SIDEBAR *************************************************************************** -->
                            ...
                            <div class="category-column">
                              ...
                              <ul>
                                 <li><?php foreach ($sk as $sks) { ?>
                                  <li>
                                   <a href="javascript:filterResultsForArtWork(<?php echo $sks->accompanyingItemTypeID?>,11)" ><?php echo ((isset($_GET['lang']) === false)?  $sks->SingularDesc : $sks->StandardName  ) ?><span><?php echo $sks->rowsum?></span> </a>
                                  </li>
                        ...
                        <div class="widget">
                            <div class="category-column">
                              ...
                              <ul>
                                ...
                                <li>
                                   <a href="javascript:filterResultsForArtWork(<?php echo $mainunity->itemTypeID?>,12)" ><?php echo ((isset($_GET['lang']) === false)?  $mainunity->SingularDesc : $mainunity->StandardName  ) ?><span><?php echo $mainunity->rowsum?></span> </a>
                                </li>
                                    <!--<li onclick ="filterResults('aaa');" class="cat-item"><?php echo ((isset($_GET['lang']) === false)?  $itemtype->PluralDesc : $itemtype->StandardName  ) ?></li>-->
                                  <?php } ?>
                               </ul>
                            ...
                            <div class="category-column">
                              ...
                              <ul>
                               <li><?php foreach ($geophysicals as $geophysical) { ?>
                                <li>
                                    <a href="javascript:filterResultsForArtWork(<?php echo $geophysical->itemTypeID?>,13)" ><?php echo ((isset($_GET['lang']) === false)?  $geophysical->SingularDesc : $geophysical->StandardName  ) ?> <span><?php echo $geophysical->rowsum?></span> </a>
                                </li>
                                 <!--<li onclick ="filterResults('aaa');" class="cat-item"><?php echo ((isset($_GET['lang']) === false)?  $itemtype->PluralDesc : $itemtype->StandardName  ) ?></li>-->
                              <?php } ?>
                              </li>
    ...
    <script type="text/javascript">
      ...
      function filterResultsForArtWork (itemTypeId,cat) {
        //console.log(cat);
        //console.logJSON.stringify(cat)

      var url = "ajax/filter_artwork_relations_with_all.php?";
